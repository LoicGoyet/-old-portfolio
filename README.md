...
Front Lab use [npm](https://github.com/npm/npm) and [gulp](https://github.com/gulpjs/gulp) for quick & smooth workflow. Npm needs to be globally installed, gulp will be installed localy into your project and is already setted.
